...
class PointcloudProcessor {
 public:
  ...
  Pointcloud::Ptr filtFromInputCloud(Pointcloud::ConstPtr inputCloud) const;
  /*!
  ...
  Pointcloud::Ptr applyReverseRigidBodyTransformation(Pointcloud::ConstPtr inputCloud) const;
 protected:
